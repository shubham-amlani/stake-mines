  ...
  return (
    ...
    <nav className='flex navbar justify-around w-full'>
      ...
      <div className="wallet py-2 px-3 flex">
        <div className="amount-box flex px-4 py-3 rounded-l-md cursor-pointer"><span className='text-sm font-bold self-center'>₹ {amount?amount.toFixed(2):'0.00'}</span> <img src="/rupee-logo.png" alt="" className='w-4 h-4 self-center m-1'/></div>
